  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{url('admin/fundraiser')}}" id="fundraiser"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Fund Raiser</span></a></li>
        @endif
        ...
        @if(Auth::user()->is_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
        <li><a class="app-menu__item" href="{{url('admin/fundrequest')}}" id="fundreq"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">Fund Raiser Request</span></a></li>
        @endif
        ...
        <li class="treeview" id="notifications"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Notifications</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{url('admin/comment')}}" id="comment"><i class="icon fa fa-circle-o"></i> Comment</a></li>
