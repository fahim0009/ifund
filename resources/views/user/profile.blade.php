        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="user-image">
              <div class="tile user-settings">
                ...
                <form>
                  <div class="row">
                    <input id="userprofileimageid" value="{{$profile_data->id}}" type="hidden">
                ...
                <form>
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input class="form-control" id="fname" value="{{$profile_data->fname}}" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Last Name</label>
                      <input class="form-control" id="lname" value="{{$profile_data->lname}}" type="text">
                    </div>
                    <div class="col-md-6">
                      <label>Email</label>
  ...
  $(document).ready(function(){
      ...
      $(".detailsBtn").click(function(){
          ...
          $.ajax({
                  ...
                  type: "PUT",
                  data:{
                    fname:fname,lname:lname,email:email,phone:phone,city:city,country:country,postal_code:postal_code,about:about,address:address
                  },
                  success: function(d){
                      if (d.status == 303) {
            ...
            $(".imgBtn").click(function(){
              var file_data = $('#image').prop('files')[0];
                  ...
                  form_data.append('_method', 'put');
                    ...
                    $.ajax({
                      url:imgurl+'/'+$("#userprofileimageid").val(),
                      method: "POST",
                      contentType: false,
                      processData: false,
                      data:form_data,
